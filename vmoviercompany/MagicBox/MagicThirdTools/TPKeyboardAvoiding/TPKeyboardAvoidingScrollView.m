...
- (void)setup {
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(TPKeyboardAvoiding_keyboardDidShow:) name:UIKeyboardDidShowNotification object:nil];
...
-(void)addExternHeight:(CGFloat)height{
    [self moreExternHeight:height];
}
@end
